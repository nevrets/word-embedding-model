...
if __name__ == '__main__':
    BASE_PATH = '/data/nevret/bert_embd/'
    ...
    w2v_model_fn =  BASE_PATH + 'tipa_model/tipa.w2v.refined.token.model'
    d2v_model_fn = BASE_PATH + 'tipa_model/tipa.d2v.refined.token.model'
    ft_model_fn = BASE_PATH + 'tipa_model/tipa.ft.refined.token.model'
    stopwords_url = BASE_PATH + 'tipa_model/stopwords.txt'
    ...
    data_ = get_parqet_file(BASE_PATH, DATA_PATH).sort_values('sbjt_id').reset_index(drop=True)
